...
% Save Figure
saveas(fig,'./Figures/price_sensitivity_sim5.png');
...
% Save Figure
saveas(fig,'./Figures/consumption_preference_sim5.png');
...
for run = 1:run_time
    ...
    for h = 1:Hours
       ...
       % Selfish - Private
       tau = beta(h)*(Ah(h)+1)/N; lambda = beta(h)/N; mu = beta(h)/N; %main parameters
       ...
       price(h,:) = beta(h) * (Ah(h)*consumption_S(run,1,:,h)+total_consumption_S(1,run,h) + omega)/N;
       ...
       price(h,:) = beta(h) * (Ah(h)*consumption_S(run,2,:,h)+total_consumption_S(2,run,h) + omega)/N;
       ...
       % Altruistic - Private
       tau = beta(h)*(Ah(h)+1)/N; lambda = 2*beta(h)/N; mu = beta(h)/N; %main parameters
       ...
       price(h,:) = beta(h) * (Ah(h)*consumption_U(run,1,:,h)+total_consumption_U(1,run,h) + omega)/N;
       ...
       price(h,:) = beta(h) * (Ah(h)*consumption_U(run,2,:,h)+total_consumption_U(2,run,h) + omega)/N;
       ...
       price(h,:) = beta(h) * (Ah(h)*consumption_W(run,1,:,h)+total_consumption_W(1,run,h) + omega)/N;
       ...
       price(h,:) = beta(h) * (Ah(h)*consumption_W(run,2,:,h)+total_consumption_W(2,run,h) + omega)/N;
       ...
       tau = beta(h)*(Ah(h)+1)/N; mu = beta(h)/N; lambda = (N + nr_neighbors')*beta(h)/(N^2); %main parameters
       rho = 1./(2.*(tau+e));       
       ...
       price(h,:) = beta(h) * (Ah(h)*consumption_C(run,1,:,h)+total_consumption_C(1,run,h) + omega)/N;
       ...
       price(h,:) = beta(h) * (Ah(h)*consumption_C(run,2,:,h)+total_consumption_C(2,run,h) + omega)/N;
    ...
    for hyb = 1:10
        ...
        for h = 1:Hours
            ...
            for cs = 1:N
                if customers(cs) == 1
                    taup(cs) = beta(h)*(Ah(h)+1)/N; lambdap(cs) = beta(h)/N; mup(cs) = beta(h)/N;
                    taub(cs) = beta(h)*(Ah(h)+1)/N; lambdab(cs) = beta(h)/N; mub(cs) = beta(h)/N;
                elseif customers(cs) == 2
                    taup(cs) = beta(h)*(Ah(h)+1)/N; lambdap(cs) = 2*beta(h)/N; mup(cs) = beta(h)/N;
                    taub(cs) = beta(h)*(Ah(h)+1)/N; lambdab(cs) = 2*beta(h)/N; mub(cs) = beta(h)/N;
                ...
                elseif customers(cs) == 4
                    taup(cs) = beta(h)*(Ah(h)+1)/N; mup(cs) = beta(h)/N;
                    lambdap(cs) = (N + nr_neighbors(cs))*beta(h)/(N^2);
                    taub(cs) = beta(h)*(Ah(h)+1)/N; mub(cs) = beta(h)/N;
            ...
            if hyb == 1
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H1(run,1,:,h)+total_consumption_H1(1,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H1(run,2,:,h)+total_consumption_H1(2,run,h) + omega)/N;
            ...
            elseif hyb == 2
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H2(run,1,:,h)+total_consumption_H2(1,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H2(run,2,:,h)+total_consumption_H2(2,run,h) + omega)/N;
            ...
            elseif hyb == 3
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H3(run,1,:,h)+total_consumption_H3(1,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H3(run,2,:,h)+total_consumption_H3(2,run,h) + omega)/N;
            ...
            elseif hyb == 4
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H4(run,1,:,h)+total_consumption_H4(1,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H4(run,2,:,h)+total_consumption_H4(2,run,h) + omega)/N;
            ...
            elseif hyb == 5
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H5(run,1,:,h)+total_consumption_H5(1,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H5(run,2,:,h)+total_consumption_H5(2,run,h) + omega)/N;
            ...
            elseif hyb == 6
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H6(run,1,:,h)+total_consumption_H6(1,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H6(run,2,:,h)+total_consumption_H6(2,run,h) + omega)/N;
            ...
            elseif hyb == 7
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H7(run,1,:,h)+total_consumption_H7(1,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H7(run,2,:,h)+total_consumption_H7(2,run,h) + omega)/N;
            ...
            elseif hyb == 8
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H8(run,1,:,h)+total_consumption_H8(1,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H8(run,2,:,h)+total_consumption_H8(2,run,h) + omega)/N;
            ...
            elseif hyb == 9
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H9(run,1,:,h)+total_consumption_H9(1,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H9(run,2,:,h)+total_consumption_H9(2,run,h) + omega)/N;
            ...
            elseif hyb == 10
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H10(run,1,:,h)+total_consumption_H10(1,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_H10(run,2,:,h)+total_consumption_H10(2,run,h) + omega)/N;
...
save './Results_Graph/sim5_avcons_S' average_consumption_S
save './Results_Graph/sim5_avcons_U' average_consumption_U
save './Results_Graph/sim5_avcons_W' average_consumption_W
save './Results_Graph/sim5_avcons_C' average_consumption_C
save './Results_Graph/sim5_avcons_H1' average_consumption_H1
save './Results_Graph/sim5_avcons_H2' average_consumption_H2
save './Results_Graph/sim5_avcons_H3' average_consumption_H3
save './Results_Graph/sim5_avcons_H4' average_consumption_H4
save './Results_Graph/sim5_avcons_H5' average_consumption_H5
save './Results_Graph/sim5_avcons_H6' average_consumption_H6
save './Results_Graph/sim5_avcons_H7' average_consumption_H7
save './Results_Graph/sim5_avcons_H8' average_consumption_H8
save './Results_Graph/sim5_avcons_H9' average_consumption_H9
save './Results_Graph/sim5_avcons_H10' average_consumption_H10
% Utility Containers
save './Results_Graph/sim5_utility_S' utility_S
save './Results_Graph/sim5_utility_U' utility_U
save './Results_Graph/sim5_utility_W' utility_W
save './Results_Graph/sim5_utility_C' utility_C
save './Results_Graph/sim5_utility_H1' utility_H1
save './Results_Graph/sim5_utility_H2' utility_H2
save './Results_Graph/sim5_utility_H3' utility_H3
save './Results_Graph/sim5_utility_H4' utility_H4
save './Results_Graph/sim5_utility_H5' utility_H5
save './Results_Graph/sim5_utility_H6' utility_H6
save './Results_Graph/sim5_utility_H7' utility_H7
save './Results_Graph/sim5_utility_H8' utility_H8
save './Results_Graph/sim5_utility_H9' utility_H9
save './Results_Graph/sim5_utility_H10' utility_H10
% Price Container
save './Results_Graph/sim5_price_container' price_container
% Revenue Containers
save './Results_Graph/sim5_revenue_container_S' revenue_container_S
save './Results_Graph/sim5_revenue_container_U' revenue_container_U
save './Results_Graph/sim5_revenue_container_W' revenue_container_W
save './Results_Graph/sim5_revenue_container_C' revenue_container_C
save './Results_Graph/sim5_revenue_container_H1' revenue_container_H1
save './Results_Graph/sim5_revenue_container_H2' revenue_container_H2
save './Results_Graph/sim5_revenue_container_H3' revenue_container_H3
save './Results_Graph/sim5_revenue_container_H4' revenue_container_H4
save './Results_Graph/sim5_revenue_container_H5' revenue_container_H5
save './Results_Graph/sim5_revenue_container_H6' revenue_container_H6
save './Results_Graph/sim5_revenue_container_H7' revenue_container_H7
save './Results_Graph/sim5_revenue_container_H8' revenue_container_H8
save './Results_Graph/sim5_revenue_container_H9' revenue_container_H9
save './Results_Graph/sim5_revenue_container_H10' revenue_container_H10
% Cost Containers
save './Results_Graph/sim5_cost_container_S' cost_container_S
save './Results_Graph/sim5_cost_container_U' cost_container_U
save './Results_Graph/sim5_cost_container_W' cost_container_W
save './Results_Graph/sim5_cost_container_C' cost_container_C
save './Results_Graph/sim5_cost_container_H1' cost_container_H1
save './Results_Graph/sim5_cost_container_H2' cost_container_H2
save './Results_Graph/sim5_cost_container_H3' cost_container_H3
save './Results_Graph/sim5_cost_container_H4' cost_container_H4
save './Results_Graph/sim5_cost_container_H5' cost_container_H5
save './Results_Graph/sim5_cost_container_H6' cost_container_H6
save './Results_Graph/sim5_cost_container_H7' cost_container_H7
save './Results_Graph/sim5_cost_container_H8' cost_container_H8
save './Results_Graph/sim5_cost_container_H9' cost_container_H9
save './Results_Graph/sim5_cost_container_H10' cost_container_H10
    ...
    for hyb = 7:10
        ...
        for h = 1:Hours
            ...
            if hyb == 7
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_24(run,1,:,h)+total_consumption_24(1,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_24(run,2,:,h)+total_consumption_24(2,run,h) + omega)/N;
            ...
            elseif hyb == 8
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_24(run,3,:,h)+total_consumption_24(3,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_24(run,4,:,h)+total_consumption_24(4,run,h) + omega)/N;
            ...
            elseif hyb == 9
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_24(run,5,:,h)+total_consumption_24(5,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_24(run,6,:,h)+total_consumption_24(6,run,h) + omega)/N;
            ...
            elseif hyb == 10
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_24(run,7,:,h)+total_consumption_24(7,run,h) + omega)/N;
               ...
               price(h,:) = beta(h) * (Ah(h)*consumption_24(run,8,:,h)+total_consumption_24(8,run,h) + omega)/N;
...
save './Results_Graph/sim5_avcons_24' average_consumption_24
% Utility Containers
save './Results_Graph/sim5_utility_24' utility_24
% Price Container
save './Results_Graph/sim5_price_container_24' price_container_24
% Revenue Containers
save './Results_Graph/sim5_revenue_container_24' revenue_container_24
% Cost Containers
save './Results_Graph/sim5_cost_container_24' cost_container_24
